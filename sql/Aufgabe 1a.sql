SELECT lb.Lieferbezirk_ID, lb.plz, COUNT(l.Lieferer_ID) AS AnzahlLieferer , 
	...
	WHERE lfb.Bestellung_NR = b.Bestellung_ID and b.bestellstatus = 'abgeschlossen' and lfb.Lieferer_NR = l.Lieferer_ID and lb1.plz = l1.plz and l1.plz = l.plz) AS AnzahlBestellungen, /*Anzahl der Abgeschlossenen Lieferungen*/ 
	...
	lb1.Bestellung_NR = b.Bestellung_ID AND lb1.Lieferer_NR = l.Lieferer_ID) AS DurchschnittBestellsumme /*Durchschnittliche Bestellsume erechnen*/
