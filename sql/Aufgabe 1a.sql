SELECT lb.Lieferbezierk_ID, lb.plz, COUNT(l.Lieferer_ID) AS AnzahlLieferer, COUNT(lfb.Lieferbestaetigung_ID) AS AnzahlLieferungen, AVG(bp.anzahl) AS DurchschnittBestellsumme
